...
---@overload fun(self: gmod_door_exterior, name: "PlayerEnter", id: string, func: fun(self: gmod_door_exterior, ply: Player, notp: boolean?, ...))
---@overload fun(self: gmod_door_exterior, name: "PlayerExit", id: string, func: fun(self: gmod_door_exterior, ply: Player, forced: boolean?, notp: boolean?, ...))
